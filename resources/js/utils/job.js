export default `<div class="job_offer">
	<p><strong>Location:</strong> Poland, Warsaw</p>
	<p>
		<strong>Industry:</strong> Computer Software
	...
	<p>
		<strong>Description:</strong> ABC Company Inc. seeks a full-time mid-level software engineer to develop in-house tools.
	</p>
	...
	<ul>
		<li>ABC Corp provides top-tier employee compensation benefits and a relaxed, team-oriented work environment, including: Medical, Life, Dental</li>
	</ul>

	<p><strong>Incentives:</strong></p>
	<ul>
		<li>Performance-based annual bonus plan, project-completion bonuses</li>
	</ul>

	<p><strong>Apply Now:</strong> If interested in this position, please email us your resume, along with salary requirements and a cover letter to <a href="mailto:jobs@example.com" target="_blank">jobs@example.com</a>.</p>

	<p>Date Posted: 2011-10-31</p>

	<p>Valid Through: 2011-12-31</p>
</div>`;

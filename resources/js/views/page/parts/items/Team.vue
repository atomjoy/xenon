...
.page_employee .employee_link {
	color: var(--text-1);
	font-weight: 700;
	font-size: 18px;
}

.page_employee .employee_link:hover {
	color: var(--accent);
}

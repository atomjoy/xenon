...
<template>
	...
	<td>
		<a :href="'/employees/' + item.slug" class="panel_list_item_link" target="_blank">
	...
	<td>
		<RouterLink class="panel_list_action_link" :to="'/admin/employees/edit/' + item.id" :title="$t('Edit')">
			<IconEdit />
		</RouterLink>

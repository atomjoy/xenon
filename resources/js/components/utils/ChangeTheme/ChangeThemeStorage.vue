...
<template>
	<div @click="toggle" :class="{ change_theme: true }" :title="$t('Theme light')">
		<div class="theme_icon theme_dark" v-if="th == 'dark'">
		...
		<div class="theme_icon theme_light" v-if="th != 'dark'" :title="$t('Theme dark')">

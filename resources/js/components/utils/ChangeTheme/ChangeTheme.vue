<script setup>
import { useThemeStore } from './stores/change_theme.js';
...
<template>
	<div
		@click="theme.toggle()"
		:class="{ change_theme: true }"
		:title="$t('Theme light')"
	>
		<div class="theme_icon theme_dark" v-if="theme.getColor == 'dark'">
		...
		<div
			class="theme_icon theme_light"
			v-if="theme.getColor != 'dark'"
			:title="$t('Theme dark')"
		>
